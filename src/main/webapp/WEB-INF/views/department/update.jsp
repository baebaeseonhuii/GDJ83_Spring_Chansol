    ...
    <div class="row justify-content-center">
      <div class="col-lg-7 col-md-9">
        <form action="./update" method="post">
          <input type="hidden" class="form-control" value="${dto.department_id}" id="department_id" name="department_id">
          <div class="mb-3">
            <label for="department_name" class="form-label">부서명</label>
            <input type="text" class="form-control" value="${dto.department_name}" id="department_name" name="department_name">
          </div>
          <div class="mb-3">
          ...
          <div class="mb-3">
            ...
            <input type="text" class="form-control" value="${dto.location_id}"  id="location_id" name="location_id">
          </div>
