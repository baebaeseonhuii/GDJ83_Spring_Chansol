    ...
    <div class="row justify-content-center mt-5">
      <div class="col-lg-7 col-md-9">
        <div class="d-md-flex justify-content-md-end">
          <a class="btn btn-primary justify-content-end me-2" href="./update" role="button">수정</a>
          <a class="btn btn-primary justify-content-end" href="#" role="button" id="delbtn">계정삭제</a>
        </div>
