...
<ul class="nav justify-content-center nav-tabs nav-pills">
  ...
  <c:choose>
    <c:when test="${empty sessionScope.member}">
      <li class="nav-item"><a class="nav-link active" aria-current="page" href="/members/join">회원가입</a></li>
      <li class="nav-item"><a class="nav-link" href="/members/login">로그인</a></li>
    </c:when>
    <c:otherwise>
      <li class="nav-item"><a class="nav-link active" aria-current="page" href="/members/mypage">마이페이지</a></li>
