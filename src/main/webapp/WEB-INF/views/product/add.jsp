...
<body>
  ...
  <div class="container">
    <form class="row g-3 mt-3" method="post">
      <div class="col-md-6">
        <label for="ITEM_NAME" class="form-label">Name</label> <input type="text" class="form-control" name="item_name">
      </div>
      <div class="col-md-6">
        <label for="ITEM_RATE" class="form-label">Rate</label> <input type="text" class="form-control" name="item_rate">
      </div>
      <div class="col-12">
